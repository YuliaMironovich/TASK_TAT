...
namespace DEV_13
{
    //Second algorithm of employer choise: by min cost of all team.
    public class MinCost: IStrategy
    {
        ...
        public List<List<int>> Algorithm(InitialCondition initialCondition)
        {
            ...
            numberOfTeam = FindPossibleTeams(numberOfTeam, countOfEmployee, initialCondition, productivity, cost, minCost);
